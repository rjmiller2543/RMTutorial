...
Pod::Spec.new do |s|
  s.name             = 'RMTutorial'
  s.version          = '0.1.0'
  s.summary          = 'A short description of RMTutorial.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/<GITHUB_USERNAME>/RMTutorial'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'rjmiller2543' => 'robertmiller2543@gmail.com' }
  s.source           = { :git => 'https://github.com/<GITHUB_USERNAME>/RMTutorial.git', :tag => s.version.to_s }
